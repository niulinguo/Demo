...
object XImageLoader : XImageActionBase<Any> {
    ...
    override fun loadImage(context: Context, imageView: XImageView<Any>) {
        proxy.loadImage(context, imageView)
    }

    override fun loadImageWithHolder(context: Context, imageView: XImageView<Any>) {
        proxy.loadImageWithHolder(context, imageView)
    }

    override fun loadImageWithThumbnail(context: Context, imageView: XImageView<Any>) {
        proxy.loadImageWithThumbnail(context, imageView)
    }

    override fun loadImageWithSize(context: Context, imageView: XImageView<Any>) {
        proxy.loadImageWithSize(context, imageView)
    }

    override fun loadImageWithAnim(context: Context, imageView: XImageView<Any>) {
        proxy.loadImageWithAnim(context, imageView)
    }

    override fun loadImageWithCache(context: Context, imageView: XImageView<Any>) {
        proxy.loadImageWithCache(context, imageView)
    }

    override fun loadCircleImage(context: Context, imageView: XImageView<Any>) {
        proxy.loadCircleImage(context, imageView)
    }

    override fun loadBlurImage(context: Context, imageView: XImageView<Any>) {
        proxy.loadBlurImage(context, imageView)
    }

    override fun loadGifImage(context: Context, imageView: XImageView<Any>) {
        proxy.loadGifImage(context, imageView)
    }

    override fun loadImageListener(
        context: Context,
        imageView: XImageView<Any>,
